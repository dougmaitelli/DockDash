...
A self-hosted dashboard for visualizing Docker containers and network services. DockDash discovers services automatically, tracks their health, and lets you map connections between them on an interactive canvas.
...
- **Persistent layout** — node positions and links are saved in a local SQLite database
