...
export const CONFIG_SCHEMA = {
  ...
  kubernetesEnabled:        { env: "KUBERNETES_ENABLED",        type: "string",         default: "false",              showOnUi: true },
  kubernetesKubeconfig:     { env: "KUBERNETES_KUBECONFIG",     type: "string",         default: null                  },
  kubernetesContexts:       { env: "KUBERNETES_CONTEXTS",       type: "string-array",   default: [],                   showOnUi: true },
  kubernetesNamespaces:     { env: "KUBERNETES_NAMESPACES",     type: "string-array",   default: ["default"],          showOnUi: true },
